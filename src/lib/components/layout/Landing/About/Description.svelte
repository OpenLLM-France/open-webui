	...
	<div>
		...
		<div class="flex flex-col space-y-4 text-justify text-sm xl:text-base 2xl:text-lg">
			<span>
				...
				OpenLLM France initiée par Michel-Marie MAUDET, Directeur Général de LINAGORA, le pionier
				français de l’Open Source le 16 juin 2023.
			</span>

			<span>
				A l’origine, LUCIE a été développée sur fonds propres par LINAGORA puis, dans un 2ème temps,
				a pu bénéficier d’un financement spécifique issu d’un Appel à Projet «&nbsp;Communs
				Numériques&nbsp;» dans le cadre du programme d’investissements d’avenir France 2030 attribué
				à un consortium public/privé comptant, en plus de LINAGORA, le CNRS, l’Ecole Politechnique,
				l’Opsci, l’association Classcode et Talkr.
			</span>
		</div>
	</div>
	<div>
